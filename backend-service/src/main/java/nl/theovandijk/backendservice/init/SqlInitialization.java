...
import nl.theovandijk.backendservice.ApplicationConfiguration;
...
@Configuration
@EnableJpaRepositories(basePackages = "nl.theovandijk.seeds.persistence", repositoryFactoryBeanClass = JpaRepositoryFactoryBean.class)
public class SqlInitialization {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        entityManagerFactoryBean.setPackagesToScan("nl.theovandijk.backendservice.representations");
